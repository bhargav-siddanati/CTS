...
public class Getdata extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<tr> <th>No</th>  <th>ID</th> <th>Name</th> <th>Branch</th> <th>Operations</th> </tr>");	
		List<Student> list = std.getData();
		list.forEach(s -> pw.println("<tr> <td>"+s.getStdNo()+"</td><td>"+s.getStdId()+"</td> <td>"+s.getStdName()+"</td> <td>"+s.getStdBranch()+"</td>  <td><a href='UpdatePage.jsp?id="+s.getStdId()+"'>edit</a>  "+"  "+" <a href='DeleteData?id="+s.getStdId()+"'>Delete</a> </td></tr>"));
